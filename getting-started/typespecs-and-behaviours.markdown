...
Defining function specs this way works, but be end up repeating the type `{number, String.t}` over and over. We can use the `@type` directive to declare our own custom type and cut down on the repetition.
